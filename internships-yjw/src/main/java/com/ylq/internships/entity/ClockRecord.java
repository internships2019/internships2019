...
public class ClockRecord {
    ...
    public ClockRecord(String wxNo, Date clockTime, String clockLocation, Double clockLongtitude, Double clockLatitude, String clockType, String clockStatus, Double deductScore, String scTeaWx) {
        this.wxNo = wxNo;
        this.clockTime = clockTime;
        this.clockLocation = clockLocation;
        this.clockLongtitude = clockLongtitude;
