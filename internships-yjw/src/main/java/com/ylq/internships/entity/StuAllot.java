...
public class StuAllot {
    ...
    public StuAllot(Integer id, String sWxNo, String state, String comName, String comLocation, String comTel, Integer jobId, String jobName, String scTeaWx, String comTeaWx, String scTeaName, String comTeaName) {
        this.id = id;
        this.sWxNo = sWxNo;
        this.state = state;
