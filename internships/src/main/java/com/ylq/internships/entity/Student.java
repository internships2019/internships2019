...
public class Student {
    ...
    public Student(String wxNo, String sNo, String sName, String sSex, String sImg, String sScName, String sState, String stuTel, String className, String bindState) {
        this.wxNo = wxNo;
        this.sNo = sNo;
        this.sName = sName;
        this.sSex = sSex;
